<template>
    <main class="w-screen h-screen flex flex-col gap-5 bg-slate-200">
        <nav class="flex justify-between text-center sticky top-0 font-mono bg-slate-700 px-10 items-center text-white p-2">
        ...
        <div class="flex justify-center">
            <div class="flex flex-col gap-5 bg-white p-3 w-full h-6/6 overflow-y-auto">
                ...
                <div class="flex w-full h-5/6 items-start bg-blue-50" v-if="currentRoom">
                    <!-- 4pics image -->
